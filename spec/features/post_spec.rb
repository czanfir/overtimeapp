...
describe 'navigate' do
  ...
  describe 'new' do
    it 'has a link from the homepage' do
      employee = Employee.create(first_name: 'Employee', last_name: 'Authorized', email: "employee@example.com", password: "testtest", password_confirmation: "testtest", phone: "5555555555")
